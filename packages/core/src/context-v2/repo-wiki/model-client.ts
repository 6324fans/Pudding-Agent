...
const REPO_WIKI_SYSTEM_PROMPT = 'You generate citation-backed repository Wiki JSON for Pudding Context V2. Use only provided evidence packet ids. Return JSON only. Do not include raw hidden reasoning.'
