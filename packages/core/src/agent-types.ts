...
- Do NOT run state-changing commands.`,
  ...
  {
    name: 'plan',
    description: 'Planning agent that analyzes code and writes implementation plans. Can only read files and write to .puddingagent/plans/ directory.',
...
# Plan structure (write to .puddingagent/plans/<slug>.md)
