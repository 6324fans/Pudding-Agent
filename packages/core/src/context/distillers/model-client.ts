...
const DISTILLER_SYSTEM_PROMPT = 'You produce durable Pudding Context Engine structured summaries. Return JSON only. Never reveal or include raw hidden reasoning/thinking.'
