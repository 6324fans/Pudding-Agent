...
export interface ContextBudgetLimits {
  ...
  maxTokens?: number
  /** @deprecated Pudding Context Engine never truncates individual sections by a local token ceiling. */
  maxSectionTokens?: number
  /** @deprecated Pudding Context Engine never truncates code context by a local token ceiling. */
...
// Product contract: Pudding Context Engine does not enforce local token, section,
