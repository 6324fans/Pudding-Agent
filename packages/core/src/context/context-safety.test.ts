    ...
    const projectProfile = validateDistillerEnvelopeForAcceptance(
      {
        ...
        payload: {
          projectPurpose: 'Ship Pudding Context Engine safely.',
          packageBoundaries: [
            {
              name: '@puddingagent/core',
              path: 'packages/core',
          ...
          commands: [{ name: 'test', command: 'pnpm --filter @puddingagent/core test', purpose: 'Run core tests.' }],
