...
Just completed: T002 "Implement todo backend" (general agent, wrote /tmp/puddingagent-todo-backend.js)
...
[
  { "type": "add_task", "task": {
      ...
      "description": "Verify T002 output. Read /tmp/puddingagent-todo-backend.js, check against .team/contracts/todo-api.md. Run node -e tests for each endpoint. Any violation: team_artifact action=create_issue on_task=T002. When done: update_status completed.",
      "priority": "high",
      "dependsOn": ["T002"]
