    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between px-5 py-3 border-b border-[#333]">
          <span className="text-[11px] uppercase tracking-[0.1em] text-[#EAEAEA]">Pudding-Agent 帮助</span>
        ...
        <div className="px-5 py-4 space-y-4">
          <section>
            ...
            <div className="space-y-1.5">
              <HelpRow cmd="/init" desc="分析项目并生成 PUDDINGAGENT.md 配置文件" />
          ...
          <section>
            ...
            <p className="text-[11px] text-[#666]">
              ...
              技能文件位于项目的 .puddingagent/skills/ 或全局 ~/.puddingagent/skills/ 目录。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[11px] text-[#666]">
              AI 修改的文件会显示在「文件变更」面板中。可以对每个文件执行「撤销」或「确认」。
          ...
          <section>
            ...
            <p className="text-[11px] text-[#666] mb-2">
              安装 IDE 扩展后，Pudding-Agent 可自动感知你在 IDE 中的操作（当前文件、选中代码），作为隐式上下文传给 AI。
            </p>
            <div className="space-y-1.5">
